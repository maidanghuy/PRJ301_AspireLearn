...
public class ReadingServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ReadingServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ReadingServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        List<Reading> questions = read.getReading(filePath); 
        ...
        request.getRequestDispatcher("views/user/reading.jsp").forward(request, response);
    } 
