<%-- Document : footer Created on : Mar 14, 2025, 10:54:17 PM Author : macbookpro --%>
    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        <div class="container">
                ...
                <div class="footer__left">
                    <div class="footer__logo">
                        <div class="footer__logo-image">
                            <img src="${img}/navbar_icon/Logo.svg" alt="G-EASY Logo" class="footer__logo-img" />
                        </div>
                    </div>
                    <p class="footer__description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed diam
                        nonummy
            ...
            <div class="footer__social">
                ...
                <a href="#" class="footer__social-link"><i class="fas fa-envelope"></i></a>
